...
class Development(commands.Cog):
    ...
    async def invite_server_command(self, ctx):
        ...
        await ctx.author.send("https://discord.gg/AxZYhTS")
        await ctx.reply("Koi_Bot의 공식 서버 초대 링크가 DM으로 전송되었습니다!")
    ...
    async def info_command(self,ctx):
        ...
        embed.add_field(name = "Reference Document", value = "이 봇은 다음의 문서를 참고하여 제작되었습니다.\n키뮤님의 Setabot 문서 : https://github.com/Kimu-Nowchira/SetaBot\n곰사냥님의 디스코드 봇 만들기 문서 : https://blog.naver.com/huntingbear21/221646735340", inline = False)
