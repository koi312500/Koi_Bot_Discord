...
class BotManagement(commands.Cog):
    ...
    async def info_command(self,ctx):
        ...
        embed.set_footer(text=f"현재 봇의 버전은 Alpha 1.0 입니다.")
        ...
        embed.add_field(name = "Execution Environment1", value = "현재, 이 봇은 Galaxy S8+ with Termux and Pixel experience로 동작중입니다.", inline = False)
        embed.add_field(name = "Execution Environment2", value = "현재, 이 봇은 LG 울트라북 15U560에서 동작중입니다.", inline = False)
